...
class general_model(object):
    def __init__(self, config):
        ...
        self.label_repeat_times = self.w_repeat * self.a_repeat
        self.model = MTNP(config).cuda()
    ...
    def one_train_iteration(self, inputs_batch, labels_batch):
        ...
        self.model.train()
        output_posterior_all, output_prior_all, kl_a, kl_w = self.model(inputs_batch, labels_batch, self.a_repeat, self.w_repeat)
    ...
    def one_test_iteration(self, inputs_batch, labels_batch):
        ...
        self.model.eval()
        output = self.model(inputs_batch, labels_batch, self.a_repeat, self.w_repeat)
